...
public class TAMBSKeyMappings
{
	...
	public static final KeyMapping PLAY = new KeyMapping("key.tambs.play", KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, InputConstants.KEY_GRAVE, "key.categories.tambs");
}
