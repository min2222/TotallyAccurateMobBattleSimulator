...
//https://github.com/Flemmli97/MobBattle/blob/1.20.1/common/src/main/java/io/github/flemmli97/mobbattle/client/gui/SuggestionEditBox.java
public class SuggestionEditBox extends EditBox 
{
    ...
    protected int paddingX = 4, paddingY = 2;
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) 
    {
        ...
        this.renderSuggestion(guiGraphics, mouseX, mouseY);
    }
    ...
    protected boolean suggestionsHidden() 
    {
    ...
    protected int indexFromMouse(double mouseY) 
    {
    ...
    protected Consumer<String> of(Consumer<String> other) 
    {
    ...
    protected void recalculateSuggestions(String input)
    {
        this.suggestions = this.allSuggestions.stream().filter(ctx -> ctx.matches(input)).map(SuggestionContent::asString).toArray(String[]::new);
